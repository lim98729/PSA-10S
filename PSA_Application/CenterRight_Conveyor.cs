...
namespace PSA_Application
{
	public partial class CenterRight_Conveyor : UserControl
	{
		...
		private void Textbox_Click(object sender, EventArgs e)
		{
			...
			if (sender.Equals(TB_REVERSE_PATTERN_SCORE1)) mc.para.setting(mc.para.HDC.modelTrayReversePattern1.passScore, out mc.para.HDC.modelTrayReversePattern1.passScore);
			...
			if (sender.Equals(TB_REVERSE_PATTERN_SCORE2)) mc.para.setting(mc.para.HDC.modelTrayReversePattern2.passScore, out mc.para.HDC.modelTrayReversePattern2.passScore);
