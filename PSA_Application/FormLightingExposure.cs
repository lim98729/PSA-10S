...
namespace PSA_Application
{
    public partial class FormLightingExposure : Form
    {
        ...
        void control()
        {
            if (mode == LIGHTEXPOSUREMODE.ULC || mode == LIGHTEXPOSUREMODE.ULC_CORNER1 || mode == LIGHTEXPOSUREMODE.ULC_CORNER2
                || mode == LIGHTEXPOSUREMODE.ULC_CORNER3 || mode == LIGHTEXPOSUREMODE.ULC_CORNER4)
            {
