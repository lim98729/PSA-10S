	...
	public partial class CenterRight_SecsGem : UserControl
	{
		...
		private void Control_Click(object sender, EventArgs e)
		{
            ...
            if (sender.Equals(TB_MPC_NAME))
            {
                ...
                mc.commMPC.mpcDomainName = TB_MPC_NAME.Text;
            }
            if (sender.Equals(TB_INPUT_TMS_PC_NAME))
            {
                mc.para.DIAG.inputTmsPCName.description = TB_INPUT_TMS_PC_NAME.Text;
                mc.commMPC.inputTmsPCName = TB_INPUT_TMS_PC_NAME.Text;
            }
            if (sender.Equals(TB_OUTPUT_TMS_PC_NAME))
            {
                mc.para.DIAG.outputTmsPCName.description = TB_OUTPUT_TMS_PC_NAME.Text;
                mc.commMPC.outputTmsPCName = TB_OUTPUT_TMS_PC_NAME.Text;
            }
