		...
		void control()
		{
			...
			while (true)
			{
				...
				if (jogMode == JOGXYZ_MODE.HD_PICK_OFFSET_SF1)
				{
                    ...
                    posZ = mc.hd.tool.tPos.z[0].PICK(UnitCodeSF.SF1);
					mc.hd.tool.jogMoveXYZ(0, posX, posY, posZ, out ret.message); if (ret.message != RetMessage.OK) { mc.message.alarmMotion(ret.message); goto EXIT; }
					#endregion
				}
				if (jogMode == JOGXYZ_MODE.HD_PICK_OFFSET_SF2)
				{
                    ...
                    posZ = mc.hd.tool.tPos.z[0].PICK(UnitCodeSF.SF2);
					mc.hd.tool.jogMoveXYZ(0, posX, posY, posZ, out ret.message); if (ret.message != RetMessage.OK) { mc.message.alarmMotion(ret.message); goto EXIT; }
					#endregion
				}
				if (jogMode == JOGXYZ_MODE.HD_PICK_OFFSET_SF3)
				{
					if (mc.swcontrol.mechanicalRevision == 0)
					{
                        ...
                        posZ = mc.hd.tool.tPos.z[0].PICK(UnitCodeSF.SF3);
					}
					else
					{
                        ...
                        posZ = mc.hd.tool.tPos.z[0].PICK(UnitCodeSF.SF5);
					}
					#region moving
					mc.hd.tool.jogMoveXYZ(0, posX, posY, posZ, out ret.message); if (ret.message != RetMessage.OK) { mc.message.alarmMotion(ret.message); goto EXIT; }
					#endregion
				...
				if (jogMode == JOGXYZ_MODE.HD_PICK_OFFSET_SF4)
				{
					if (mc.swcontrol.mechanicalRevision == 0)
					{
                        ...
                        posZ = mc.hd.tool.tPos.z[0].PICK(UnitCodeSF.SF4);
					}
					else
					{
                        ...
                        posZ = mc.hd.tool.tPos.z[0].PICK(UnitCodeSF.SF6);
					}
					#region moving
					mc.hd.tool.jogMoveXYZ(0, posX, posY, posZ, out ret.message); if (ret.message != RetMessage.OK) { mc.message.alarmMotion(ret.message); goto EXIT; }
					#endregion
				...
				if (jogMode == JOGXYZ_MODE.HD_PICK_OFFSET_SF7)
				{
                    ...
                    posZ = mc.hd.tool.tPos.z[0].PICK(UnitCodeSF.SF7);
					mc.hd.tool.jogMoveXYZ(0, posX, posY, posZ, out ret.message); if (ret.message != RetMessage.OK) { mc.message.alarmMotion(ret.message); goto EXIT; }
					#endregion
				}
				if (jogMode == JOGXYZ_MODE.HD_PICK_OFFSET_SF8)
				{
                    ...
                    posZ = mc.hd.tool.tPos.z[0].PICK(UnitCodeSF.SF8);
					mc.hd.tool.jogMoveXYZ(0, posX, posY, posZ, out ret.message); if (ret.message != RetMessage.OK) { mc.message.alarmMotion(ret.message); goto EXIT; }
					#endregion
				}
				#endregion
