	...
	public partial class CenterRight_HeadCamera : UserControl
	{
		...
		private void Control_Click(object sender, EventArgs e)
		{
			...
			if (sender.Equals(BT_SelectModel_PAD))
			{
                ...
                if (mc.para.HDC.modelPAD.algorism.value == (int)MODEL_ALGORISM.NCC || mc.para.HDC.modelPAD.algorism.value == (int)MODEL_ALGORISM.SHAPE)
                {
                    TS_PassScore.Visible = true;
                    TS_CROPAREA.Visible = false;
                }
                else if (mc.para.HDC.modelPAD.algorism.value == (int)MODEL_ALGORISM.CORNER || mc.para.HDC.modelPAD.algorism.value == (int)MODEL_ALGORISM.PROJECTION
                    || mc.para.HDC.modelPAD.algorism.value == (int)MODEL_ALGORISM.RECTANGLE || mc.para.HDC.modelPAD.algorism.value == (int)MODEL_ALGORISM.CIRCLE)
                {
			...
			if (sender.Equals(BT_SelectModel_PADC1))
			{
                ...
                if (mc.para.HDC.modelPADC1.algorism.value == (int)MODEL_ALGORISM.NCC || mc.para.HDC.modelPADC1.algorism.value == (int)MODEL_ALGORISM.SHAPE)
                {
                    TS_PassScore.Visible = true;
                    TS_CROPAREA.Visible = false;
                }
                else if (mc.para.HDC.modelPADC1.algorism.value == (int)MODEL_ALGORISM.CORNER || mc.para.HDC.modelPADC1.algorism.value == (int)MODEL_ALGORISM.PROJECTION
                    || mc.para.HDC.modelPADC1.algorism.value == (int)MODEL_ALGORISM.RECTANGLE || mc.para.HDC.modelPADC1.algorism.value == (int)MODEL_ALGORISM.CIRCLE)
                {
                    TS_PassScore.Visible = false;
                    TS_CROPAREA.Visible = true;
                }
			...
			if (sender.Equals(BT_SelectModel_PADC2))
			{
                ...
                if (mc.para.HDC.modelPADC2.algorism.value == (int)MODEL_ALGORISM.NCC || mc.para.HDC.modelPADC2.algorism.value == (int)MODEL_ALGORISM.SHAPE)
                {
                    TS_PassScore.Visible = true;
                    TS_CROPAREA.Visible = false;
                }
                else if (mc.para.HDC.modelPADC2.algorism.value == (int)MODEL_ALGORISM.CORNER || mc.para.HDC.modelPADC2.algorism.value == (int)MODEL_ALGORISM.PROJECTION
                    || mc.para.HDC.modelPADC2.algorism.value == (int)MODEL_ALGORISM.RECTANGLE || mc.para.HDC.modelPADC2.algorism.value == (int)MODEL_ALGORISM.CIRCLE)
                {
                    TS_PassScore.Visible = false;
                    TS_CROPAREA.Visible = true;
                }
			...
			if (sender.Equals(BT_SelectModel_PADC3))
			{
                ...
                if (mc.para.HDC.modelPADC3.algorism.value == (int)MODEL_ALGORISM.NCC || mc.para.HDC.modelPADC3.algorism.value == (int)MODEL_ALGORISM.SHAPE)
                {
                    TS_PassScore.Visible = true;
                    TS_CROPAREA.Visible = false;
                }
                else if (mc.para.HDC.modelPADC3.algorism.value == (int)MODEL_ALGORISM.CORNER || mc.para.HDC.modelPADC3.algorism.value == (int)MODEL_ALGORISM.PROJECTION
                    || mc.para.HDC.modelPADC3.algorism.value == (int)MODEL_ALGORISM.RECTANGLE || mc.para.HDC.modelPADC3.algorism.value == (int)MODEL_ALGORISM.CIRCLE)
                {
                    TS_PassScore.Visible = false;
                    TS_CROPAREA.Visible = true;
                }
			...
			if (sender.Equals(BT_SelectModel_PADC4))
			{
                ...
                if (mc.para.HDC.modelPADC4.algorism.value == (int)MODEL_ALGORISM.NCC || mc.para.HDC.modelPADC4.algorism.value == (int)MODEL_ALGORISM.SHAPE)
                {
                    TS_PassScore.Visible = true;
                    TS_CROPAREA.Visible = false;
                }
                else if (mc.para.HDC.modelPADC4.algorism.value == (int)MODEL_ALGORISM.CORNER || mc.para.HDC.modelPADC4.algorism.value == (int)MODEL_ALGORISM.PROJECTION
                    || mc.para.HDC.modelPADC4.algorism.value == (int)MODEL_ALGORISM.RECTANGLE || mc.para.HDC.modelPADC4.algorism.value == (int)MODEL_ALGORISM.CIRCLE)
                {
                    TS_PassScore.Visible = false;
                    TS_CROPAREA.Visible = true;
                }
            ...
            {
                if (mode == SELECT_FIND_MODEL.HDC_PAD) { goto EXIT; }
                if (mode == SELECT_FIND_MODEL.HDC_PADC1) mc.para.setting(ref mc.para.HDC.modelPADC1.algorism, (int)MODEL_ALGORISM.RECTANGLE);
                if (mode == SELECT_FIND_MODEL.HDC_PADC2) mc.para.setting(ref mc.para.HDC.modelPADC2.algorism, (int)MODEL_ALGORISM.RECTANGLE);
                if (mode == SELECT_FIND_MODEL.HDC_PADC3) mc.para.setting(ref mc.para.HDC.modelPADC3.algorism, (int)MODEL_ALGORISM.RECTANGLE);
                if (mode == SELECT_FIND_MODEL.HDC_PADC4) mc.para.setting(ref mc.para.HDC.modelPADC4.algorism, (int)MODEL_ALGORISM.RECTANGLE);
                mc.hdc.model_delete(mode);
...
// 			}
			...
			if (sender.Equals(BT_Lighiting_Jog))
			{
				...
				{
					mc.hd.tool.jogMove((int)UnitCodeHead.HD1, mc.hd.tool.cPos.x.PAD(padIndexX), mc.hd.tool.cPos.y.PAD(padIndexY), mc.para.CAL.toolAngleOffset[(int)UnitCodeHead.HD1].value, out ret.message); if (ret.message != RetMessage.OK) { mc.message.alarmMotion(ret.message); goto EXIT; }
				}
				if (mode == SELECT_FIND_MODEL.HDC_PADC1)
				{
                    mc.hd.tool.jogMove((int)UnitCodeHead.HD1, mc.hd.tool.cPos.x.PADC1(padIndexX), mc.hd.tool.cPos.y.PADC1(padIndexY), mc.para.CAL.toolAngleOffset[(int)UnitCodeHead.HD1].value, out ret.message); if (ret.message != RetMessage.OK) { mc.message.alarmMotion(ret.message); goto EXIT; }
				}
				if (mode == SELECT_FIND_MODEL.HDC_PADC2)
				{
                    mc.hd.tool.jogMove((int)UnitCodeHead.HD1, mc.hd.tool.cPos.x.PADC2(padIndexX), mc.hd.tool.cPos.y.PADC2(padIndexY), mc.para.CAL.toolAngleOffset[(int)UnitCodeHead.HD1].value, out ret.message); if (ret.message != RetMessage.OK) { mc.message.alarmMotion(ret.message); goto EXIT; }
				}
				if (mode == SELECT_FIND_MODEL.HDC_PADC3)
				{
                    mc.hd.tool.jogMove((int)UnitCodeHead.HD1, mc.hd.tool.cPos.x.PADC3(padIndexX), mc.hd.tool.cPos.y.PADC3(padIndexY), mc.para.CAL.toolAngleOffset[(int)UnitCodeHead.HD1].value, out ret.message); if (ret.message != RetMessage.OK) { mc.message.alarmMotion(ret.message); goto EXIT; }
				}
				if (mode == SELECT_FIND_MODEL.HDC_PADC4)
				{
                    mc.hd.tool.jogMove((int)UnitCodeHead.HD1, mc.hd.tool.cPos.x.PADC4(padIndexX), mc.hd.tool.cPos.y.PADC4(padIndexY), mc.para.CAL.toolAngleOffset[(int)UnitCodeHead.HD1].value, out ret.message); if (ret.message != RetMessage.OK) { mc.message.alarmMotion(ret.message); goto EXIT; }
				}
		...
		void refresh()
		{
			...
			else
			{
				...
				if (mode == SELECT_FIND_MODEL.HDC_PAD)
				{
                    ...
                    if (mc.para.HDC.modelPAD.algorism.value != (int)MODEL_ALGORISM.PROJECTION && mc.para.HDC.modelPAD.algorism.value != (int)MODEL_ALGORISM.CORNER)
					{
                        ...
                        if (mc.para.HDC.modelPAD.algorism.value == (int)MODEL_ALGORISM.NCC)
                        {
                            ...
                            if (mc.para.HDC.modelPAD.isCreate.value == (int)BOOL.TRUE)
                            {
                                try
                                {
                                    ...
                                    if (mc.para.HDC.modelPAD.algorism.value == (int)MODEL_ALGORISM.NCC) number = (int)HDC_MODEL.PAD_NCC;
                                    else number = (int)HDC_MODEL.PAD_SHAPE;
                                    sizeX = mc.hdc.cam.model[number].createColumn2 - mc.hdc.cam.model[number].createColumn1;
                                    sizeY = mc.hdc.cam.model[number].createRow2 - mc.hdc.cam.model[number].createRow1;
                                    ratio = sizeY / sizeX;
                                    double height;
                                    height = hWC_Model.Width * ratio;
                                    hWC_Model.Height = (int)height;
                                    HOperatorSet.SetPart(hWC_Model.HalconID, 0, 0, mc.hdc.cam.model[number].createRow2 - mc.hdc.cam.model[number].createRow1,
                                        mc.hdc.cam.model[number].createColumn2 - mc.hdc.cam.model[number].createColumn1);
                                    HOperatorSet.DispImage(mc.hdc.cam.model[number].CropDomainImage, hWC_Model.HalconID);
                                }
                                catch
                                {
                                }
				...
				if (mode == SELECT_FIND_MODEL.HDC_PADC1)
				{
                    ...
                    if (mc.para.HDC.modelPADC1.algorism.value != (int)MODEL_ALGORISM.PROJECTION && mc.para.HDC.modelPADC1.algorism.value != (int)MODEL_ALGORISM.CORNER)
					{
						hWC_Model.Visible = true;
                        ...
                        if (mc.para.HDC.modelPADC1.algorism.value == (int)MODEL_ALGORISM.NCC)
                        {
                            ...
                            if (mc.para.HDC.modelPADC1.isCreate.value == (int)BOOL.TRUE)
                            {
                                ...
                                {
                                    HTuple sizeX, sizeY, ratio;
                                    if (mc.para.HDC.modelPADC1.algorism.value == (int)MODEL_ALGORISM.NCC) number = (int)HDC_MODEL.PADC1_NCC;
                                    else number = (int)HDC_MODEL.PADC1_SHAPE;
                                    sizeX = mc.hdc.cam.model[number].createColumn2 - mc.hdc.cam.model[number].createColumn1;
                                    sizeY = mc.hdc.cam.model[number].createRow2 - mc.hdc.cam.model[number].createRow1;
                                    ratio = sizeY / sizeX;
                                    double height;
				...
				if (mode == SELECT_FIND_MODEL.HDC_PADC2)
				{
                    ...
                    if (mc.para.HDC.modelPADC2.algorism.value != (int)MODEL_ALGORISM.PROJECTION && mc.para.HDC.modelPADC2.algorism.value != (int)MODEL_ALGORISM.CORNER)
					{
						hWC_Model.Visible = true;
                        ...
                        if (mc.para.HDC.modelPADC2.algorism.value == (int)MODEL_ALGORISM.NCC)
                        {
                            ...
                            if (mc.para.HDC.modelPADC2.isCreate.value == (int)BOOL.TRUE)
                            {
                                ...
                                {
                                    HTuple sizeX, sizeY, ratio;
                                    if (mc.para.HDC.modelPAD.algorism.value == (int)MODEL_ALGORISM.NCC) number = (int)HDC_MODEL.PADC2_NCC;
                                    else number = (int)HDC_MODEL.PADC2_SHAPE;
                                    sizeX = mc.hdc.cam.model[number].createColumn2 - mc.hdc.cam.model[number].createColumn1;
                                    sizeY = mc.hdc.cam.model[number].createRow2 - mc.hdc.cam.model[number].createRow1;
                                    ratio = sizeY / sizeX;
                                    double height;
				...
				if (mode == SELECT_FIND_MODEL.HDC_PADC3)
				{
                    ...
                    if (mc.para.HDC.modelPADC3.algorism.value != (int)MODEL_ALGORISM.PROJECTION && mc.para.HDC.modelPADC3.algorism.value != (int)MODEL_ALGORISM.CORNER)
					{
						hWC_Model.Visible = true;
                        ...
                        if (mc.para.HDC.modelPADC3.algorism.value == (int)MODEL_ALGORISM.NCC)
                        {
                            ...
                            if (mc.para.HDC.modelPADC3.isCreate.value == (int)BOOL.TRUE)
                            {
                                ...
                                {
                                    HTuple sizeX, sizeY, ratio;
                                    if (mc.para.HDC.modelPAD.algorism.value == (int)MODEL_ALGORISM.NCC) number = (int)HDC_MODEL.PADC3_NCC;
                                    else number = (int)HDC_MODEL.PADC3_SHAPE;
                                    sizeX = mc.hdc.cam.model[number].createColumn2 - mc.hdc.cam.model[number].createColumn1;
                                    sizeY = mc.hdc.cam.model[number].createRow2 - mc.hdc.cam.model[number].createRow1;
                                    ratio = sizeY / sizeX;
                                    double height;
				...
				if (mode == SELECT_FIND_MODEL.HDC_PADC4)
				{
                    ...
                    if (mc.para.HDC.modelPADC4.algorism.value != (int)MODEL_ALGORISM.PROJECTION && mc.para.HDC.modelPADC4.algorism.value != (int)MODEL_ALGORISM.CORNER)
					{
						hWC_Model.Visible = true;
                        ...
                        if (mc.para.HDC.modelPADC4.algorism.value == (int)MODEL_ALGORISM.NCC)
                        {
                            ...
                            if (mc.para.HDC.modelPADC4.isCreate.value == (int)BOOL.TRUE)
                            {
                                ...
                                {
                                    HTuple sizeX, sizeY, ratio;
                                    if (mc.para.HDC.modelPAD.algorism.value == (int)MODEL_ALGORISM.NCC) number = (int)HDC_MODEL.PADC4_NCC;
                                    else number = (int)HDC_MODEL.PADC4_SHAPE;
                                    sizeX = mc.hdc.cam.model[number].createColumn2 - mc.hdc.cam.model[number].createColumn1;
                                    sizeY = mc.hdc.cam.model[number].createRow2 - mc.hdc.cam.model[number].createRow1;
                                    ratio = sizeY / sizeX;
                                    double height;
...
// 				TB_AngleExtent.Text = angelExtent;
        ...
        private void CenterRight_HeadCamera_Load(object sender, EventArgs e)
        {
            if (mc.para.HDC.modelPAD.algorism.value == (int)MODEL_ALGORISM.NCC || mc.para.HDC.modelPAD.algorism.value == (int)MODEL_ALGORISM.SHAPE)
            {
                TS_PassScore.Visible = true;
