	...
	public partial class FormUserMessage : Form
	{
		...
		private void Button_Click(object sender, EventArgs e)
		{
			if (sender.Equals(BT_SELECT1))
			{
                ...
                else if (dialogMode == DIAG_SEL_MODE.RetrySkipCancel) diagResult = DIAG_RESULT.Retry;
                else if (dialogMode == DIAG_SEL_MODE.HD1HD2Cancel) diagResult = DIAG_RESULT.HD1;
				this.Close();
			}
			if (sender.Equals(BT_SELECT2))
			{
                ...
                else if (dialogMode == DIAG_SEL_MODE.RetrySkipCancel) diagResult = DIAG_RESULT.Skip;
                else if (dialogMode == DIAG_SEL_MODE.HD1HD2Cancel) diagResult = DIAG_RESULT.HD2;
				this.Close();
			}
			if (sender.Equals(BT_SELECT3))
			{
                ...
                else if (dialogMode == DIAG_SEL_MODE.RetrySkipCancel) diagResult = DIAG_RESULT.Cancel;
                else if (dialogMode == DIAG_SEL_MODE.HD1HD2Cancel) diagResult = DIAG_RESULT.Cancel;
				this.Close();
			}
		}
	}
