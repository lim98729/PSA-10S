...
namespace AccessoryLibrary
{
	public partial class loadScope : UserControl
	{
		...
		public loadScope()
		{
            ...
            EVENT.onAdd_addLoadcellData2 += new EVENT.InsertHandler_addLoadcellData2(addLoadcellData2);
        ...
        delegate void addLoadcellData_Call2(int seriesNum, double xVal, double yVal);
        void addLoadcellData2(int seriesNum, double xVal, double yVal)
        {
            if (this.loadcellChart.InvokeRequired)
            {
                addLoadcellData_Call2 d = new addLoadcellData_Call2(addLoadcellData2);
                this.loadcellChart.BeginInvoke(d, new object[] { seriesNum, xVal, yVal });
            }
            else
            {
                //if (UtilityControl.graphControlDataDisplay > 0)
